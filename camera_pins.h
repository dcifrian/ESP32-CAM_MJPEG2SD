...
#elif defined(CAMERA_MODEL_UICPAL_ESP32S3_CAM)
// UICPAL ESP32-S3 CAM board (ESP32-S3FN8, 16MB flash, 8MB OPI PSRAM)
// PWDN and RESET are GPIO-controlled per schematic (not -1)
// LED on GPIO34 (via R49), UART on GPIO43/44 (CH340X)
// Free pins for peripherals: GPIO1 (ADC1_CH0, LDR), GPIO15 (LED drive)
#define CAM_BOARD "CAMERA_MODEL_UICPAL_ESP32S3_CAM"
#define PWDN_GPIO_NUM     46  // pulled down via R52 1K, GPIO-controlled
#define RESET_GPIO_NUM    45  // GPIO-controlled
#define XCLK_GPIO_NUM     10
#define SIOD_GPIO_NUM     21
#define SIOC_GPIO_NUM     14
